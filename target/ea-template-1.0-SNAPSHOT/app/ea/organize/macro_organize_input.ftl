	...
	<#list organizeNodes as organize>
	    <tr>
			...
			<#if organizeNodes?size?string=="1" > 
				<a  onclick="javascript:action_organize('change_level.do','id=${organize.id?if_exists}');" class="btn btn-xs  btn-default"> <span class="glyphicon glyphicon-arrow-left"  title="钱一级"></span></a>     
			<#else>
