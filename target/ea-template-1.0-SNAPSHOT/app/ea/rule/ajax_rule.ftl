...
<#macro digui_rule ruleNodes  flag >
	<#list ruleNodes as rule>
	    ...
	    <tr>
			...
			<td width=200px  >		 	     
			    <a href=ea_ruledetail_menu_ruledetail.do?parentId=${rule.id}   target=mainFrame >内容编辑</a>
			    	<a href=ea_rule_detail.do?id=${rule.id?if_exists} onclick="return hs.htmlExpand(this, { objectType: 'iframe' })">预览</a>
