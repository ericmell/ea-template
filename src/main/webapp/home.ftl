...
<a href="login.ftl"  class="btn btn-lg btn-primary" target=_blank>login登录&数据初始化</a>
		...
		<table class="table">
		    <thead>
		  	...
		  	<tbody>
		        ...
		        <tr><td>model对话框</td><td><span class="glyphicon glyphicon-ok"/></td><td></td><td></td><td></td><td></td></tr>
...
<div class="panel panel-default">    
	<div class="panel-heading"><strong>业务场景公共模块矩阵</strong></div>
	<div class="panel-body">
		...
		<table class="table">
		    <thead>
		  	...
		  	<tbody>
		        ...
		        <tr><td><a href="login.ftl" target=_blank>login登录</a>  </td><td></tr>
		        <tr><td><a href="common_test_upload.do" target=_blank>文件上传</a><td></td></tr>
		        <tr><td><a href="common_test_upload.do" target=_blank>图片上传</a></td><td></td></tr>
		        <tr><td><a href="common_test_upload.do" target=_blank>文字编辑保存</a></td><td></td></tr>
		        <tr><td><a href="common_test_date.do" target=_blank>如何获取当前用户的项目ID公司ID</a></td><td></td></tr>
				<tr><td><a href="common_test_menu_para.do" target=_blank>演示"数据词典功能"</a></td><td></td></tr>
				<tr><td><a href="xuanren" target=_blank>人员选择</a></td><td></td></tr>
...
<br><strong>WEB项目常见代码架构</strong><br>
<pre>
