         ...
         <tr>
           <td width=300px valign=top>
	           ...
	           <div class="panel panel-info">
		           <div class="panel-heading">
		              <h7 class="panel-title">组织架构信息</h7>
		           </div>
		           <div class="panel-body">
						...
						<#macro digui_role_v treeNodes  flag >
						   	<#list treeNodes as role>
							   	    ...
							   	    <tr>	
							 	  	     ...
							 	  	     <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</strong>						 	  	     						 	  	     					 	  	     
							 	  	     <a  href="ea_ea_sumReport.do?theYear=${year}&type=year&userAccount=${u.account}&user=${u.name}" target="mainFrame">&nbsp年报</a>
							 	  	     <a  href="ea_ea_sumReport.do?theYear=${year}&type=season&userAccount=${u.account}&user=${u.name}" target="mainFrame">&nbsp季报</a>
							 	  	     <a  href="ea_ea_sumReport.do?theYear=${year}&type=month&userAccount=${u.account}&user=${u.name}" target="mainFrame">&nbsp月报</a>
							 	  	     <a  href="ea_ea_sumReport.do?theYear=${year}&type=week&userAccount=${u.account}&user=${u.name}" target="mainFrame">&nbsp周报</a>
							 	  	     <a  href="ea_ea_sumReport.do?theYear=${year}&type=day&userAccount=${u.account}&user=${u.name}" target="mainFrame"> 日报</a>
							 	  	     </td>
								 	</tr>	  
									</#list>
				    	...
				    	<#if ( rhs["user"].getRoles()?size gt 0 )>
							<#list rhs["user"].getRoles() as role>
								<#if ( role.getChildRoles()?size gt 0 )>
									...
									<table class ="table">
			<tr>
				<td width=250px><b>${role.name?if_exists} </b>下属成员:</td>	
